...
// void featherwrite(matlab::mex::ArgumentList outputs, matlab::mex::ArgumentList inputs) {
...
void featherread(matlab::mex::ArgumentList outputs, matlab::mex::ArgumentList inputs) {
  const std::string filename{mxArrayToUTF8String(prhs[0])};
